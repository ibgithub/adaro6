...
describe('Component Tests', () => {
    describe('StepsMySuffix Management Component', () => {
        let comp: StepsMySuffixComponent;
        let fixture: ComponentFixture<StepsMySuffixComponent>;
        let service: StepsMySuffixService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [Adaro6TestModule],
                declarations: [StepsMySuffixComponent],
                providers: [
                    {
                ...
                .overrideTemplate(StepsMySuffixComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(StepsMySuffixComponent);
